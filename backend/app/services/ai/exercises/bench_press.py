"""
ATHLETIX — Bench Press Metric Extractor
services/ai/exercises/bench_press.py

Sport: Powerlifting

Metrics extracted (Phase 4/5 TODO):
  bar_path_deviation, elbow_angle_bottom, arch_consistency, lockout_angle
...
def extract_metrics(keypoints_per_frame: list[list[dict[str, Any]]]) -> dict[str, Any]:
    """
    Extracts Bench Press-specific performance metrics from BlazePose keypoints.
    ...
    logger.warning("bench_press.extract_metrics is a stub (Phase 4/5 TODO)")
