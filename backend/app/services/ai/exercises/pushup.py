"""
ATHLETIX — Push-up Metric Extractor
services/ai/exercises/pushup.py

Sport: Calisthenics

Metrics extracted (Phase 4/5 TODO):
  elbow_angle_bottom, body_plank_deviation, lockout_angle, rep_count
...
def extract_metrics(keypoints_per_frame: list[list[dict[str, Any]]]) -> dict[str, Any]:
    """
    Extracts Push-up-specific performance metrics from BlazePose keypoints.
    ...
    logger.warning("pushup.extract_metrics is a stub (Phase 4/5 TODO)")
